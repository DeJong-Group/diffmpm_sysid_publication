...
# experiment options
SNR_dB_choices = [-13.1, -3, 7.8, 21.8, 38.4]
init_e_choices = [1e3, 1e4, 1.5e4]

SNR_dB = SNR_dB_choices[0]
...
with open(f"result_db_{int(SNR_dB)}_init_{int(init_e)}.json", "w") as outfile: 
